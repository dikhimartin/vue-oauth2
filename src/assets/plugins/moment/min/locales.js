(function (global, factory) {
   ...
   factory(global.moment)
    ...
    var bs = moment.defineLocale('bs', {
        ...
        weekdays : 'nedjelja_ponedjeljak_utokatalog_srijeda_četvrtak_petak_subota'.split('_'),
    ...
    //! komento: Mi estas malcerta se mi korekte tkatalogtis akuzativojn en tiu traduko.
    ...
    //! moment.js locale configuration
    //! locale : Georgian (ka)
    //! author : Ikatalogli Janiashvili : https://github.com/ikatalogli-janiashvili
    ...
    var me = moment.defineLocale('me', {
        ...
        weekdays: ['nedjelja', 'ponedjeljak', 'utokatalog', 'srijeda', 'četvrtak', 'petak', 'subota'],
    ...
    var sr = moment.defineLocale('sr', {
        months: ['januar', 'februar', 'mart', 'april', 'maj', 'jun', 'jul', 'avgust', 'septembar', 'oktobar', 'novembar', 'decembar'],
        monthsShort: ['jan.', 'feb.', 'mar.', 'apr.', 'maj', 'jun', 'jul', 'avg.', 'sep.', 'okt.', 'nov.', 'dec.'],
        weekdays: ['nedelja', 'ponedeljak', 'utokatalog', 'sreda', 'četvrtak', 'petak', 'subota'],
    ...
    //!           Bukatalog Yiğit Kaya: https://github.com/BYK
