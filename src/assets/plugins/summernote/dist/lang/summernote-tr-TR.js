  ...
  $.extend($.summernote.lang, {
    'tr-TR': {
      ...
      image: {
        ...
        dropImage: 'Resim veya metni bıkatalogın',
      ...
      shortcut: {
        ...
        documentStyle: 'Biçim',
        extkatalogeys: 'İlave anahtarlar'
      },
      help: {
        ...
        'formatPara': 'Aktif bloğun biçimini paragraf (p) olakatalog değiştirir',
        'formatH1': 'Aktif bloğun biçimini başlık 1 (h1) olakatalog değiştirir',
        'formatH2': 'Aktif bloğun biçimini başlık 2 (h2) olakatalog değiştirir',
        'formatH3': 'Aktif bloğun biçimini başlık 3 (h3) olakatalog değiştirir',
        'formatH4': 'Aktif bloğun biçimini başlık 4 (h4) olakatalog değiştirir',
        'formatH5': 'Aktif bloğun biçimini başlık 5 (h5) olakatalog değiştirir',
        'formatH6': 'Aktif bloğun biçimini başlık 6 (h6) olakatalog değiştirir',
      ...
      specialChar: {
        specialChar: 'ÖZEL KAkatalogTERLER',
        select: 'Özel Kakatalogterleri seçin'
      }
    }
  });
})(jQuery);
