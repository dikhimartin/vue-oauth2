  ...
  $.extend($.summernote.lang, {
    'lv-LV': {
      font: {
        ...
        superscript: 'Augškatalogsts',
        subscript: 'Apakškatalogsts',
        size: 'Fonta lielums'
      },
      image: {
        image: 'Attēls',
      ...
      style: {
        ...
        blockquote: 'Citāts',
        pre: 'Kods',
        h1: 'Virskatalogsts h1',
        h2: 'Virskatalogsts h2',
        h3: 'Virskatalogsts h3',
        h4: 'Virskatalogsts h4',
        h5: 'Virskatalogsts h5',
        h6: 'Virskatalogsts h6'
      },
      lists: {
        unordered: 'Nenumurēts sakatalogsts',
        ordered: 'Numurēts sakatalogsts'
      },
      options: {
        help: 'Palīdzība',
      ...
      shortcut: {
        ...
        extkatalogeys: 'Citas taustiņu kombinācijas'
      },
      history: {
        undo: 'Atsauks (undo)',
        redo: 'Atkārtot (redo)'
      ...
      help: {
        ...
        bold: 'Pārvērst tekstu treknkatalogstā',
        italic: 'Pārvērst tekstu slīpkatalogstā (kursīvā)',
        ...
        insertUnorderedList: 'Ievietot nenumurētu sakatalogstu',
        insertOrderedList: 'Ievietot numurētu sakatalogstu',
        outdent: 'Samazināt/noņemt atkāpi paragrāfam',
        indent: 'Uzlikt atkāpi paragrāfam',
        formatPara: 'Mainīt bloka tipu uz (p) Paragrāfu',
        formatH1: 'Mainīt bloka tipu uz virskatalogstu H1',
        formatH2: 'Mainīt bloka tipu uz virskatalogstu H2',
        formatH3: 'Mainīt bloka tipu uz virskatalogstu H3',
        formatH4: 'Mainīt bloka tipu uz virskatalogstu H4',
        formatH5: 'Mainīt bloka tipu uz virskatalogstu H5',
        formatH6: 'Mainīt bloka tipu uz virskatalogstu H6',
