...
(function (factory) {
  ...
  var Renderer = function () {
    ...
    var tplExtraShortcuts = function (lang, options) {
      var extkatalogeys = options.extkatalogeys;
      var keys = [];

      for (var key in extkatalogeys) {
        if (extkatalogeys.hasOwnProperty(key)) {
          keys.push({ kbd: key, text: extkatalogeys[key] });
        }
      }

      return tplShortcut(lang.shortcut.extkatalogeys, keys);
    };
