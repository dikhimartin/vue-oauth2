$(function() {
    ...
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function() {
        ...
        for (var i = window.location, org = window.origin, o = $("ul#sidebarnav a").filter(function() {
            if(this.href == org+"/") return this.href == i;
            return org==this.href || String(i).indexOf(this.href) >= 0;
